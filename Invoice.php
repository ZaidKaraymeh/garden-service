...
if (isset($_SESSION['from_booking']) && !empty($_SESSION['from_booking'])) {
	...
	<body>
						...
						<ul class="navbar-nav me-auto mb-2 mb-lg-0">
							...
							<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu bg-dark">
									...
									<li><a class="dropdown-item text-white" aria-current="page"
											href="services.php">Services</a></li>
									<li><a class="dropdown-item text-white" href="register.php">Register</a></li>
									<li><a class="dropdown-item text-white" aria-current="page" href="about.php">About
											US</a></li>
								</ul>
							</li>
							<?php
		...
		<div class="invoice-box my-5" id="invoh">
			<table cellpadding="0" cellspacing="0">
				<tr class="top">
					<td colspan="2">
						<table>
							<tr>
								<td class="title">
									<img src="./img/services/<?php echo $_SESSION['from_booking']['service_pic_booking']; ?>"
				...
				<tr class="details">
					<td>
						<?php echo ucfirst($_SESSION['from_booking']['pay_booking']); ?>
					</td>
				...
				<tr class="item">
					<td>
						<?php echo $_SESSION['from_booking']['service_name_booking']; ?>
					</td>
		...
		<div class="container">
			<div class="row d-flex justify-content-center align-items-center">
				<button onclick="window.print()" class="btn btn-outline-secondary my-5" style="width: 250px;">Print Invoice</button>
			</div>
		</div>
	</body>
	...
	$price = $_SESSION['from_booking']['service_price_booking'];
	$db = new config;

	$db->query("SELECT `spending` from user where id =:id ;");
